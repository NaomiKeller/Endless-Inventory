...
public final class ServerConfigs {
    ...
    public static final ConfigEntryImpl<MissingEndInvPolicy> CREATION_MODE = register(new ConfigEntryImpl.EnumEntry<>("EndinvCreationMode", CMT_CREATION_MODE, MissingEndInvPolicy.CREATE_PER_PLAYER));
