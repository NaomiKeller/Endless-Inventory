...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    @Override public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        try {
            ...
            Boolean v = readBooleanFromToml("experimental", "jeiAttachedRecipeTransfer");
            if (v != null) {
                LOGGER.info("NeoForge mixin fallback read: experimental.jeiAttachedRecipeTransfer={} ", v);
                return v;
            }
            LOGGER.warn("NeoForge mixin config not yet loaded; defaulting jeiAttachedRecipeTransfer=false");
            return false;
        }
    }
